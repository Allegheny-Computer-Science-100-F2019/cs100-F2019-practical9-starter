# cs100-F2019-practical9-starter
...
> Task :run
Gregory M. Kapfhammer Fri Nov 22 10:41:11 EST 2019
...
- The DisplaySymbols.java in src/main/java/practicalnine has at least 1 of the `println(` fragment
- The DisplaySymbols.java in src/main/java/practicalnine has at least 2 multiple-line Java comment(s)
- The DisplaySymbols.java in src/main/java/practicalnine has at least 2 of the `print(` fragment
- The DisplaySymbols.java in src/main/java/practicalnine has at least 4 single-line Java comment(s)
- The DisplaySymbols.java in src/main/java/practicalnine has exactly 0 of the `Add Your Name Here` fragment
- The DisplaySymbols.java in src/main/java/practicalnine has exactly 0 of the `TODO` fragment
- The DisplaySymbols.java in src/main/java/practicalnine has exactly 1 of the `package practicalnine;` fragment
- The command `gradle -q --console plain run` executes correctly
- The command `gradle build` executes correctly
- The command output has exactly 38 lines
- The file DisplaySymbols.java exists in the src/main/java/practicalnine directory
...
```
        ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
        ┃ Passed 12/12 (100%) of checks for cs100-F2019-practical9! ┃
        ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
```
...
```
git remote add download git@github.com:Allegheny-Computer-Science-100-F2019/cs100-F2019-practical9-starter.git
```
...
9](https://github.com/Allegheny-Computer-Science-100-F2019/cs100-F2019-practical9-starter)
repository and [raise an
issue](https://github.com/Allegheny-Computer-Science-100-F2019/cs100-F2019-practical9-starter/issues).
